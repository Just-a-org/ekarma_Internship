...
(function () {
	...
	const rmvIdx = parseInt(prompt("Enter index from which element should be removed"));
...
(function () {
	ques("8. W.A.P. to print all employees' data whose salary is greater than 20000 and dept is sales.");
